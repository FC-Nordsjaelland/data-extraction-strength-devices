...
st.markdown("3) Choose the time of testing and the interval of acceptance - _multiple files for one player will be aggregated within the specified time interval_")
